...
namespace Database\Paginator {
    ...
    class Paginator {
         ...
         * @param $query
         */
        public function set($config, $query, $args = null){
            $db = new Database($config);            
            $this->_query = $query;
            //$con = $db->prepAndBind($query, $args);
            $con = $db->con->query($query);
        ...
        public function linker(){
            ...
            $html       .= '<li class="page-item">
                                <a class="page-link" href="?limit=' . $this->_limit . '&page=' . ( $this->_page - 1 ) . '">&laquo;</a>
                                </li>';

            if ( $start > 1 ) {
                $html   .= '<li class="page-item">
                                <a class="page-link" href="?limit=' . $this->_limit . '&page=1">1</a>
                                </li>';
            ...
            $html       .= '<li class="page-item"><a class="page-link" href="?limit=' . $this->_limit . '&page=' . ( $this->_page + 1 ) . '">&raquo;</a></li>';
